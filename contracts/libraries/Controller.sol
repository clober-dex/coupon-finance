...
import {ICouponAddressProvider} from "../interfaces/ICouponAddressProvider.sol";
...
abstract contract Controller is ERC1155Holder {
    ...
    ICouponAddressProvider internal immutable _couponAddressProvider;
    ...
    constructor(
        ...
        address couponAddressProvider,
        address cloberMarketFactory,
        address couponManager,
        address weth
    ) {
        _wrapped1155Factory = IWrapped1155Factory(wrapped1155Factory);
        _couponAddressProvider = ICouponAddressProvider(couponAddressProvider);
