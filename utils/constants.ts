...
export const CHAINLINK_FEEDS: { [chainId: number]: { [name: string]: string } } = {
  ...
  [TESTNET_ID]: {
    [TOKEN_KEYS.WETH]: '0x35Fb341F9244C9D45aE740AE8527CAeA4A5cbCF0',
    [TOKEN_KEYS.USDC]: '0xAa5AEa7A315e64e20a7a0e12e35A289649Db6A04',
    [TOKEN_KEYS.DAI]: '0x49EC5aeaFB856cacFb9A9f4d4e4baBD87bAb746d',
    [TOKEN_KEYS.USDT]: '0xDbF834695E2780967855c54eee9d71193dd6f833',
    [TOKEN_KEYS.WBTC]: '0x2E437540F8A5e72Adc122aaa69bdA28e38813B16',
  },
}
