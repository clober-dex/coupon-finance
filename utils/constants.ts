...
export const AAVE_SUBSTITUTES: { [chainId: number]: { [name: string]: string } } = {
  [TESTNET_ID]: {
    [TOKEN_KEYS.WETH]: '0x4AA389F38a7396b08e1c8EA366981c4cc6edD40D',
    [TOKEN_KEYS.USDC]: '0xB0398746Dd595bE9A7EfA98fBf0a6bD27bf6e6d2',
    [TOKEN_KEYS.DAI]: '0x1aAd87174B823f9F0EfC1f4BAa3eBa56c0cF666C',
    [TOKEN_KEYS.USDT]: '0x2486d988564aC4fAadF0bDd5B8AFB1647a583B01',
    [TOKEN_KEYS.WBTC]: '0xB4F511D3715e48d2A60c116E9fbc9165D9CDF57e',
  },
}
